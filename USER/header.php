      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="index.php"><img src="assets/img/header-logo.png" alt="VMS"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list ">
                ...
                <li class="menu-item-has-children"><a href="#" class="st-smooth-move">Hospitals</a>
                <ul>
                ...
                <li class="menu-item-has-children"><a href="#" class="st-smooth-move">Vaccine</a>
                <ul>
