...
<input type="text" class="form-control" id="exampleFormControlInput1" disabled value="<?php echo $data2['HOSPITAL_NAME']?>">
<input type="hidden" class="form-control" name="hospital" id="exampleFormControlInput1"  value="<?php echo $data2['HOSPITAL_NAME']?>">
</div>
